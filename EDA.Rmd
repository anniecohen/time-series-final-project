...
In our project, we are taking data from the LA times github repository of COVID cases in the LA county. We will be splitting the data up into three sections, by month, and completing our analyses for each subset of the data. In this code, we will complete a Boxcox test to measure significance, data transformation, and confidence intervals to help us understand th data and also how to best analyze it. We will also perform acf and pacf to determine seasonality and check for major outliers and trends in the data. 
