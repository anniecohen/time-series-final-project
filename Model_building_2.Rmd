...
plot(seasonal.ts.1.2, type = "l", xlab = "Week", ylab = "Number of New Cases", main = "COVID-19 new case data in Los Angeles county \nJuly 15 to September 30")
points(seasonal.ts.1.2, pch = as.vector(season(seasonal.ts.1.2)), cex = 0.8, col = "blue")
...
* ARIMA(0,0,1)x(0,1,0)[7]
* ARIMA(0,1,2)x(0,1,0)[7]
...
arima.seasonal.ts.1.2.4 <- arima(trans.seasonal.ts.1.2, order = c(0,0,1), seasonal = list(order = c(0,1,0), period = 7))
arima.ts.1.2.5 <- arima(diff(trans.ts.1.2, lag = 7), order = c(0,1,2))
```
...
Box.test(arima.seasonal.ts.1.2.4$residuals, type = "Ljung-Box")
Box.test(arima.ts.1.2.5$residuals, type = "Ljung-Box")
```
...
shapiro.test(arima.seasonal.ts.1.2.4$residuals)
shapiro.test(arima.ts.1.2.5$residuals)
```
...
runs(arima.seasonal.ts.1.2.4$residuals)
runs(arima.ts.1.2.5$residuals)
```
...
hist(arima.seasonal.ts.1.2.4$residuals)
hist(arima.ts.1.2.5$residuals)
...
qqnorm(arima.seasonal.ts.1.2.4$residuals)
qqline(arima.seasonal.ts.1.2.4$residuals)

qqnorm(arima.ts.1.2.5$residuals)
qqline(arima.ts.1.2.5$residuals)
```
